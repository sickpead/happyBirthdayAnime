 ...
 *
 * Значения уезжают в CSS-переменные, которые читает `DeskHubObjects.module.css`.
 * Контактные и падающие тени — не здесь: они рисуются отдельными слоями
 * (`src/constants/deskObjectShadows.ts`), в ту же сторону, что тень стола на траве.
 */
